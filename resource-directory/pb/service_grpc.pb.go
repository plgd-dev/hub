...
func (c *resourceDirectoryClient) GetLatestDeviceETags(ctx context.Context, in *GetLatestDeviceETagsRequest, opts ...grpc.CallOption) (*GetLatestDeviceETagsResponse, error) {
	...
	err := c.cc.Invoke(ctx, ResourceDirectory_GetLatestDeviceETags_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// UnimplementedResourceDirectoryServer must be embedded to have
...
func (UnimplementedResourceDirectoryServer) testEmbeddedByValue()                           {}
...
func RegisterResourceDirectoryServer(s grpc.ServiceRegistrar, srv ResourceDirectoryServer) {
	// If the following call pancis, it indicates UnimplementedResourceDirectoryServer was
