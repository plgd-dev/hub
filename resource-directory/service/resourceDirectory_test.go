...
// 	store.Append(Resource0.DeviceId, Resource0.ToUUID(), mockEvents.MakeResourceChangedEvent(Resource0.GetResourceId(), &Resource0.Content, events.MakeEventMeta("a", 0, 1)))
...
// 	store.Append(Resource1.DeviceId, Resource1.ToUUID(), mockEvents.MakeResourceChangedEvent(Resource1.GetResourceId(), &Resource1.Content, events.MakeEventMeta("a", 0, 1)))
...
// 	store.Append(Resource2.DeviceId, Resource2.ToUUID(), mockEvents.MakeResourceChangedEvent(Resource2.GetResourceId(), &Resource2.Content, events.MakeEventMeta("a", 0, 1)))
...
// 	store.Append(Resource3.DeviceId, Resource3.ToUUID(), mockEvents.MakeResourceChangedEvent(Resource3.GetResourceId(), &Resource3.Content, events.MakeEventMeta("a", 0, 1)))
// 	return store
// }
