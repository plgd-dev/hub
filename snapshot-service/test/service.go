...
import (
	...
	"github.com/plgd-dev/hub/v2/snapshot-service/service"
	"github.com/plgd-dev/hub/v2/snapshot-service/store"
	storeConfig "github.com/plgd-dev/hub/v2/snapshot-service/store/config"
	storeCqlDB "github.com/plgd-dev/hub/v2/snapshot-service/store/cqldb"
	storeMongo "github.com/plgd-dev/hub/v2/snapshot-service/store/mongodb"
...
func MakeConfig(t require.TestingT) service.Config {
	...
	cfg.APIs.GRPC = config.MakeGrpcServerConfig(config.SNAPSHOT_SERVICE_HOST)
	cfg.APIs.HTTP.Addr = config.SNAPSHOT_SERVICE_HTTP_HOST
