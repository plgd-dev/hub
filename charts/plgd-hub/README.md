...
| coapgateway.serviceStatus | object | `{"timeToLive":"10m"}` | Service status section |
| coapgateway.serviceStatus.timeToLive | string | `"10m"` | Time to update the service status of the service. Must be greater than 1s. |
