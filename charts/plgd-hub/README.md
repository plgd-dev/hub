...
| certificateauthority.service.crt.extraDnsNames | string | `nil` | Extra DNS name for service certificate |
...
| grpcgateway.service.crt.extraDnsNames | string | `nil` | Extra DNS name for service certificate |
...
| httpgateway.service.crt.extraDnsNames | string | `nil` | Extra DNS name for service certificate |
...
| identitystore.service | object | `{"annotations":{},"crt":{"extraDnsNames":null},"labels":{},"name":"grpc","protocol":"TCP","targetPort":"grpc","type":"ClusterIP"}` | Service configuration |
| identitystore.service.annotations | object | `{}` | Service annotations |
| identitystore.service.crt.extraDnsNames | string | `nil` | Extra DNS name for service certificate |
...
| mockoauthserver.service.crt.extraDnsNames | string | `nil` | Extra DNS name for service certificate |
...
| resourceaggregate.service.crt.extraDnsNames | string | `nil` | Extra DNS name for service certificate |
...
| resourcedirectory.service.crt.extraDnsNames | string | `nil` | Extra DNS name for service certificate |
