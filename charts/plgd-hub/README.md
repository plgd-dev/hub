...
| coapgateway.service.tcp.nodePort | string | `nil` | Use nodePort if specified |
...
| coapgateway.service.udp.name | string | `"coaps"` | Name |
| coapgateway.service.udp.nodePort | string | `nil` | Use nodePort if specified |
| coapgateway.service.udp.protocol | string | `"UDP"` | Protocol |
| coapgateway.service.udp.targetPort | string | `"coaps"` | Target port |
