{{- define "plgd-cloud.certificateauthority.fullname" -}}
...
{{- define  "plgd-cloud.certificateauthority.image" -}}
...
{{- define  "plgd-cloud.certificateauthority.configSecretName" -}}
    {{- $fullName :=  include "plgd-cloud.certificateauthority.fullname" . -}}
    {{- printf "%s-cfg" $fullName }}
{{- end -}}

{{- define "plgd-cloud.certificateauthority.createServiceCertByCm" }}
...
{{- define "plgd-cloud.certificateauthority.domain" -}}
...
{{- define "plgd-cloud.certificateauthority.serviceCertName" -}}
  {{- $fullName := include "plgd-cloud.certificateauthority.fullname" . -}}
  {{- printf "%s-crt" $fullName -}}
{{- end }}

{{- define "plgd-cloud.certificateauthority.domainCertName" -}}
  {{- $fullName := include "plgd-cloud.certificateauthority.fullname" . -}}
  {{- printf "%s-domain-crt" $fullName -}}
{{- end }}

{{- define "plgd-cloud.certificateauthority.selectorLabels" -}}
