...
require (
	...
	github.com/plgd-dev/device v1.1.1-0.20220407125338-94d40f88b01b
	github.com/plgd-dev/go-coap/v2 v2.5.1-0.20220406065136-30f28f635512
...
require (
	...
	github.com/pion/dtls/v2 v2.1.4-0.20220401050848-b6c0234d3c58 // indirect
