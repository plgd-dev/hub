...
require (
	...
	github.com/plgd-dev/device/v2 v2.1.1-0.20230503091447-8d6e6ec259df
	github.com/plgd-dev/go-coap/v3 v3.1.3-0.20230504151955-8f16feb9d8f3
...
require (
	...
	// note: must be kept at v1.9.0 as long as golang1.18 is supported
