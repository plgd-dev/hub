...
func RegisterGrpcGatewayHandlerServer(ctx context.Context, mux *runtime.ServeMux, server GrpcGatewayServer) error {
	...
	mux.Handle("DELETE", pattern_GrpcGateway_DeleteDevices_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		rctx, err := runtime.AnnotateIncomingContext(ctx, mux, req, "/ocf.cloud.grpcgateway.pb.GrpcGateway/DeleteDevices", runtime.WithHTTPPathPattern("/api/v1/devices"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("DELETE", pattern_GrpcGateway_CancelPendingCommands_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		ctx = grpc.NewContextWithServerTransportStream(ctx, &stream)
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		rctx, err := runtime.AnnotateIncomingContext(ctx, mux, req, "/ocf.cloud.grpcgateway.pb.GrpcGateway/CancelPendingCommands", runtime.WithHTTPPathPattern("/api/v1/pending-commands"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("DELETE", pattern_GrpcGateway_CancelPendingMetadataUpdates_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		ctx = grpc.NewContextWithServerTransportStream(ctx, &stream)
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		rctx, err := runtime.AnnotateIncomingContext(ctx, mux, req, "/ocf.cloud.grpcgateway.pb.GrpcGateway/CancelPendingMetadataUpdates", runtime.WithHTTPPathPattern("/api/v1/devices/{device_id}/pending-metadata-updates"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
...
func RegisterGrpcGatewayHandlerClient(ctx context.Context, mux *runtime.ServeMux, client GrpcGatewayClient) error {
	...
	mux.Handle("DELETE", pattern_GrpcGateway_DeleteDevices_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		defer cancel()
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		rctx, err := runtime.AnnotateContext(ctx, mux, req, "/ocf.cloud.grpcgateway.pb.GrpcGateway/DeleteDevices", runtime.WithHTTPPathPattern("/api/v1/devices"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("DELETE", pattern_GrpcGateway_CancelPendingCommands_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		defer cancel()
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		rctx, err := runtime.AnnotateContext(ctx, mux, req, "/ocf.cloud.grpcgateway.pb.GrpcGateway/CancelPendingCommands", runtime.WithHTTPPathPattern("/api/v1/pending-commands"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("DELETE", pattern_GrpcGateway_CancelPendingMetadataUpdates_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		defer cancel()
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		rctx, err := runtime.AnnotateContext(ctx, mux, req, "/ocf.cloud.grpcgateway.pb.GrpcGateway/CancelPendingMetadataUpdates", runtime.WithHTTPPathPattern("/api/v1/devices/{device_id}/pending-metadata-updates"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
