...
func TestShutdownServiceWithDeviceIssue627(t *testing.T) {
	...
	_, shutdownDevSim := test.OnboardDevSim(ctx, t, pb.NewGrpcGatewayClient(grpcConn), deviceID, config.COAPS_TCP_SCHEME+config.COAP_GW_HOST, test.GetAllBackendResourceLinks())
