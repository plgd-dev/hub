...
func TestProvisioningWithExpiringCertificate(t *testing.T) {
	...
	hubShutdown := hubTestService.SetUpServices(context.Background(), t, hubTestService.SetUpServicesOAuth|hubTestService.SetUpServicesId|
...
func TestProvisioningWithDeletedEnrollmentGroup(t *testing.T) {
	defer test.ClearDB(t)
	hubShutdown := hubTestService.SetUpServices(context.Background(), t, hubTestService.SetUpServicesCertificateAuthority|hubTestService.SetUpServicesOAuth|hubTestService.SetUpServicesId|
		hubTestService.SetUpServicesCoapGateway|hubTestService.SetUpServicesResourceAggregate|hubTestService.SetUpServicesResourceDirectory|hubTestService.SetUpServicesGrpcGateway)
	defer hubShutdown()
