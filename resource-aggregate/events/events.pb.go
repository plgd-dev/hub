...
type ServicesHeartbeat struct {
	...
	Online  []*ServicesHeartbeat_Heartbeat `protobuf:"bytes,1,rep,name=online,proto3" json:"online,omitempty"`   // services which are online
	Offline []*ServicesHeartbeat_Heartbeat `protobuf:"bytes,2,rep,name=offline,proto3" json:"offline,omitempty"` // services which are offline
}
...
func (x *ServicesHeartbeat) GetOnline() []*ServicesHeartbeat_Heartbeat {
	if x != nil {
		return x.Online
	}
	return nil
...
func (x *ServicesHeartbeat) GetOffline() []*ServicesHeartbeat_Heartbeat {
	if x != nil {
		return x.Offline
	}
	return nil
...
type ServicesMetadataUpdated struct {
	...
	Heartbeat     *ServicesHeartbeat     `protobuf:"bytes,1,opt,name=heartbeat,proto3" json:"heartbeat,omitempty"`
...
func (x *ServicesMetadataUpdated) GetHeartbeat() *ServicesHeartbeat {
	if x != nil {
		return x.Heartbeat
	}
	return nil
...
type ServicesHeartbeat_Heartbeat struct {
	...
	HeartbeatValidUntil int64  `protobuf:"varint,2,opt,name=heartbeat_valid_until,json=heartbeatValidUntil,proto3" json:"heartbeat_valid_until,omitempty"` // unix timestamp in nanoseconds (https://golang.org/pkg/time/#Time.UnixNano) when service heartbeat is considered as expired.
}
...
func (x *ServicesHeartbeat_Heartbeat) GetHeartbeatValidUntil() int64 {
	if x != nil {
...
var file_resource_aggregate_pb_events_proto_rawDesc = []byte{
	...
	0x65, 0x61, 0x67, 0x67, 0x72, 0x65, 0x67, 0x61, 0x74, 0x65, 0x2e, 0x70, 0x62, 0x2e, 0x45, 0x76,
	0x65, 0x6e, 0x74, 0x4d, 0x65, 0x74, 0x61, 0x64, 0x61, 0x74, 0x61, 0x52, 0x0d, 0x65, 0x76, 0x65,
	0x6e, 0x74, 0x4d, 0x65, 0x74, 0x61, 0x64, 0x61, 0x74, 0x61, 0x22, 0x8b, 0x02, 0x0a, 0x11, 0x53,
	0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x73, 0x48, 0x65, 0x61, 0x72, 0x74, 0x62, 0x65, 0x61, 0x74,
	0x12, 0x49, 0x0a, 0x06, 0x6f, 0x6e, 0x6c, 0x69, 0x6e, 0x65, 0x18, 0x01, 0x20, 0x03, 0x28, 0x0b,
	...
	,
...
var file_resource_aggregate_pb_events_proto_depIdxs = []int32{
	...
	34, // 77: resourceaggregate.pb.ServicesHeartbeat.online:type_name -> resourceaggregate.pb.ServicesHeartbeat.Heartbeat
	34, // 78: resourceaggregate.pb.ServicesHeartbeat.offline:type_name -> resourceaggregate.pb.ServicesHeartbeat.Heartbeat
	17, // 79: resourceaggregate.pb.ServicesMetadataUpdated.heartbeat:type_name -> resourceaggregate.pb.ServicesHeartbeat
