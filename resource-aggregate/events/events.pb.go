...
func (x *DeviceCloudStatusSnapshotTaken) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
func (x *DeviceCloudStatusSnapshotTaken) GetOnline() *commands.OnlineState {
	if x != nil {
		return x.Online
	}
	return nil
...
func (x *DeviceCloudStatusSnapshotTaken) GetResourceObservations() *commands.ResourceObservationsState {
	if x != nil {
...
func (x *DeviceCloudStatusSnapshotTaken) GetAuditContext() *commands.AuditContext {
	if x != nil {
		return x.AuditContext
	}
	return nil
...
func (x *DeviceCloudStatusSnapshotTaken) GetEventMetadata() *EventMetadata {
	if x != nil {
		return x.EventMetadata
	}
	return nil
