...
var (
	aggregateID1 = hubTest.GenerateIDbyIdx("a", 1)
	aggregateID2 = hubTest.GenerateIDbyIdx("a", 2)
	aggregateID3 = hubTest.GenerateIDbyIdx("a", 3)
	aggregateID4 = hubTest.GenerateIDbyIdx("a", 4)

	groupID1 = hubTest.GenerateDeviceIDbyIdx(1)
	groupID2 = hubTest.GenerateDeviceIDbyIdx(2)
	groupID3 = hubTest.GenerateDeviceIDbyIdx(3)
)
