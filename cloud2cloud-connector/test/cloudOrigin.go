...
var (
	C2C_CONNECTOR_EVENTS_URL        = HTTPS_SCHEME + C2C_CONNECTOR_HOST + c2curi.Events
	C2C_CONNECTOR_OAUTH_CALLBACK    = HTTPS_SCHEME + C2C_CONNECTOR_HOST + "/oauthCbk"
	OAUTH_MANAGER_ENDPOINT_TOKENURL = HTTPS_SCHEME + OAUTH_HOST + uri.Token
)
...
func SetUpCloudWithConnector(t *testing.T) (TearDown func()) {
	...
	idCfg.APIs.GRPC.Authorization.Authority = HTTPS_SCHEME + OAUTH_HOST
	...
	raCfg.APIs.GRPC.Authorization.Authority = HTTPS_SCHEME + OAUTH_HOST
	...
	rdCfg.APIs.GRPC.Authorization.Authority = HTTPS_SCHEME + OAUTH_HOST
	...
	grpcCfg.APIs.GRPC.Authorization.Authority = HTTPS_SCHEME + OAUTH_HOST
	...
	c2cConnectorCfg.APIs.HTTP.Authorization.Authority = HTTPS_SCHEME + OAUTH_HOST
