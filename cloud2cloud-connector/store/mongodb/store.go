...
type Config struct {
	Host         string        `yaml:"uri" json:"uri" envconfig:"URI" default:"mongodb://localhost:27017"`
	DatabaseName string        `yaml:"database" json:"database" envconfig:"NAME" default:"cloud2cloudConnector"`
