...
func (c *stubServiceClient) TestCall(ctx context.Context, in *TestRequest, opts ...grpc.CallOption) (*TestResponse, error) {
	...
	err := c.cc.Invoke(ctx, StubService_TestCall_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *stubServiceClient) TestStream(ctx context.Context, opts ...grpc.CallOption) (StubService_TestStreamClient, error) {
	stream, err := c.cc.NewStream(ctx, &StubService_ServiceDesc.Streams[0], StubService_TestStream_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
