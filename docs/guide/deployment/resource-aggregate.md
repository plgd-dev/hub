...
| Property | Type | Description | Default |
| ---------- | -------- | -------------- | ------- |
| `clients.eventStore.defaultCommandsTTL` | string | `Replaces time to live in CreateResource, RetrieveResource, UpdateResource, DeleteResource and UpdateDeviceMetadata commands when it is zero value. 0s - means forever.` | `"0s"` |
