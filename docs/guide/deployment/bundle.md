...
```bash
docker pull plgd/bundle:v2next
```
...
- [GRPC](https://github.com/plgd-dev/cloud/blob/v2/grpc-gateway/pb/service.proto)
- [HTTP](https://github.com/plgd-dev/cloud/blob/v2/http-gateway/swagger.yaml)
