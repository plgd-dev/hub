...
SUBDIRS := test/oauth-server authorization resource-aggregate resource-directory cloud2cloud-connector cloud2cloud-gateway coap-gateway grpc-gateway certificate-authority bundle http-gateway
