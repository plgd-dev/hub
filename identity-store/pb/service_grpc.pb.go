...
func (c *identityStoreClient) GetDevices(ctx context.Context, in *GetDevicesRequest, opts ...grpc.CallOption) (IdentityStore_GetDevicesClient, error) {
	stream, err := c.cc.NewStream(ctx, &IdentityStore_ServiceDesc.Streams[0], "/identitystore.pb.IdentityStore/GetDevices", opts...)
	if err != nil {
		return nil, err
	}
	x := &identityStoreGetDevicesClient{stream}
...
type identityStoreGetDevicesClient struct {
	grpc.ClientStream
}

func (x *identityStoreGetDevicesClient) Recv() (*Device, error) {
	m := new(Device)
...
func (c *identityStoreClient) AddDevice(ctx context.Context, in *AddDeviceRequest, opts ...grpc.CallOption) (*AddDeviceResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/identitystore.pb.IdentityStore/AddDevice", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *identityStoreClient) DeleteDevices(ctx context.Context, in *DeleteDevicesRequest, opts ...grpc.CallOption) (*DeleteDevicesResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/identitystore.pb.IdentityStore/DeleteDevices", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedIdentityStoreServer) GetDevices(*GetDevicesRequest, IdentityStore_GetDevicesServer) error {
...
func _IdentityStore_GetDevices_Handler(srv interface{}, stream grpc.ServerStream) error {
	...
	return srv.(IdentityStoreServer).GetDevices(m, &identityStoreGetDevicesServer{stream})
}
...
type identityStoreGetDevicesServer struct {
	grpc.ServerStream
}

func (x *identityStoreGetDevicesServer) Send(m *Device) error {
...
func _IdentityStore_AddDevice_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/identitystore.pb.IdentityStore/AddDevice",
	}
...
func _IdentityStore_DeleteDevices_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/identitystore.pb.IdentityStore/DeleteDevices",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
