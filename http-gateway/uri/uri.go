...
const (
	...
	IncludeNonexistentResourcesQueryKey = "includeNonexistentResources"
	ForceQueryKey                       = "force"
...
var QueryCaseInsensitive = map[string]string{
	...
	strings.ToLower(IncludeNonexistentResourcesQueryKey): IncludeNonexistentResourcesQueryKey,
