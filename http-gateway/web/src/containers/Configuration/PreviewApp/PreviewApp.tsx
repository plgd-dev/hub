...
const PreviewApp = forwardRef<PreviewAppRefType, any>((props, ref) => {
    ...
    useImperativeHandle(ref, () => ({
        getThemeData: () => getThemeTemplate(colorPalette, defaultLogo),
    }))
    ...
    const handleThemeUpdate = useCallback(() => {
        dispatch(setPreviewTheme(getThemeTemplate(colorPalette, defaultLogo)))
        dispatch(setThemeModal(false))
    }, [colorPalette, defaultLogo, dispatch])
