...
const openAppliedConfigurationItem = async (page: Page) => {
    await page.goto('')
...
test('snippet-service-conditions-detail', async ({ page }) => {
    await openAppliedConfigurationItem(page)
...
test('snippet-service-conditions-detail-tab-1-configuration-link', async ({ page }) => {
    await openAppliedConfigurationItem(page)
...
test('snippet-service-conditions-detail-tab-1-condition-link', async ({ page }) => {
    await openAppliedConfigurationItem(page)
