...
func MakeConfig(t *testing.T) service.Config {
	...
	cfg.Service.Http.Addr = config.OAUTH_SERVER_HOST
	cfg.Service.Http.TLSConfig.ClientCertificateRequired = false

	cfg.Service.Http.IDTokenPrivateKeyPath = os.Getenv("TEST_OAUTH_SERVER_ID_TOKEN_PRIVATE_KEY")
	cfg.Service.Http.AccessTokenKeyPrivateKeyPath = os.Getenv("TEST_OAUTH_SERVER_ACCESS_TOKEN_PRIVATE_KEY")
	cfg.Service.Http.Domain = "localhost"
